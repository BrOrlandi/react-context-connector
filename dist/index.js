...
var connectContext = function connectContext(ContextProvider, mapContextToProps) {
  return function (Component) {
    return function (_React$Component) {
      _inherits(WrappedContextComponent, _React$Component);

      function WrappedContextComponent() {
        _classCallCheck(this, WrappedContextComponent);

        return _possibleConstructorReturn(this, (WrappedContextComponent.__proto__ || Object.getPrototypeOf(WrappedContextComponent)).apply(this, arguments));
      }

      _createClass(WrappedContextComponent, [{
        key: 'render',
        value: function render() {
          ...
          return _react2.default.createElement(
            ...
            null,
            function (context) {
              return _react2.default.createElement(Component, _extends({}, mapContextToProps(context), _this2.props));
            }
          );
        }
      }]);
